 ...
 * This is a 2 input, 3 middle, 1 output network which is trained to 
 * discover if a point is above or below a line.
 * 
 ...
 * 
 * Maintenance History: 
 * $Log: BpDemo1.java,v $ Revision 1.5 2002/02/03 20:31:41 gsc 
 * Format tweaks
 * 
...
public class BpDemo1 extends BackProp {
   ...
   * @param momentum
   */
  public BpDemo1(int inputPopulation, int middlePopulation, int outputPopulation, double learningRate, double momentum) {
